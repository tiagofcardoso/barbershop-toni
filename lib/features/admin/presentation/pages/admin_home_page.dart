...
import 'package:barbershop/features/auth/data/auth_service.dart'; // Logout logic might need this later
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    _buildStat('Hoje', todayCount, Colors.blue),
                    _buildStat('Pendentes', pendingCount, Colors.orange),
                    _buildStat(
                        'Total', appointments.length.toString(), Colors.white),
                  ],
                ),
              ),
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final String customerId =
                        appointment['customerId'] ?? ''; // Handle old data
